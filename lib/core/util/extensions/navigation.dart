...
extension NavigationHelper on BuildContext {
  push(Widget page) {
    return Navigator.of(this).push(FadePageRoute(builder: (context) => page));
  }

  Future<dynamic> pushWithNamed(String pageRoute, {Object? arguments}) {
  ...
  pushReplacement(Widget page) {
    Navigator.of(
      this,
    ).pushReplacement(FadePageRoute(builder: (context) => page));
  }
