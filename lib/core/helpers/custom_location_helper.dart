...
import 'package:box_app/core/widgets/custom_location_permission_dialog.dart';
...
class LocationHelper {
  ...
  static Future<Position> getCurrentPosition() async {
    try {
      ...
      throw Exception(
        'Failed to get current location. Please check your location settings or try again later',
      );
    }
  }
