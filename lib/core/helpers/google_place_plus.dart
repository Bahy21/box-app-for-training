import 'package:box_app/core/api/http_search_places.dart';
import 'package:box_app/core/constants/api_constants.dart';
import 'package:box_app/core/models/place_lat_long_model.dart';
import 'package:box_app/core/models/place_model.dart';
  ...
  static Future<List<PlaceModel>> getSuggestions({
    ...
    if (response['status'] == GoogleMapsCallStatus.ok.value) {
      return List<PlaceModel>.from(
        ...
        GoogleMapsCallStatus.invalidRequest.value) {
      return [];
